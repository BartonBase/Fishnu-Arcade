...
const invaderBulletSpeed = 1.0; // Reverted to 1.2 (from 60% increase on 0.75, then 100% to 2.4)
...
const tankBulletSpeed = 0.5; // Reverted to 0.64 (from 60% increase on 0.4, then 100% to 1.28)
...
const guardianBulletSpeed = 1.0; // Reverted to 1.2 (from 60% increase on 0.75, then 100% to 2.4)
let shootTimer = 0;
