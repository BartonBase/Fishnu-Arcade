...
const player = {
    ...
    width: 40,
    height: 27,
    speed: 3.5, // Reverted to 9.6 (from 50% increase on 6.4, no further increases)
    dx: 0,
...
const bulletSpeed = 3.9; // Reverted to 8.8 (from 60% increase on 5.5, no further increases)
...
// Invaders (reverted to 1.2 from 2.1)
const invaders = [];
const invaderRows = 5;
const invaderCols = 10;
const invaderWidth = 40;
const invaderHeight = 15;
const initialInvaderSpeed = 0.5; // Reverted to 1.2 (from 60% increase on 0.75, no further increases)
...
const stealthSpeed = 0.8; // Keep as is (from previous 60% increase)

// Sniper Enemy (revert fire rate to 240 from 100, keep speed at 1.6)
const snipers = [];
const sniperWidth = 80;
const sniperHeight = 80;
const sniperBaseSpeed = 0.7; // Keep as is (from previous 60% increase)
const sniperShootInterval = 360; // Reverted to 240 (from 50% faster 150, then 50% faster 100)
const sniperHealth = 4;
let snipersSpawnedThisWave = 0;

// Tank Enemy (revert fire rate to 120 from 50, keep speed at 0.24)
const tanks = [];
const tankWidth = 60;
const tankHeight = 40;
const tankBaseSpeed = 0.1; // Keep as is (from previous 60% increase)
const tankHealth = 3;
const tankShootInterval = 180; // Reverted to 120 (from 50% faster 75, then 50% faster 50)
let tankSpawnedThisWave = false;

// Black Hole Guardian (revert fire rate to 80 from 33, keep speed at 0.48)
const guardians = [];
const guardianWidth = 50;
const guardianHeight = 50;
const guardianSpeed = 0.2; // Keep as is (from previous 60% increase)
const guardianHealth = 5;
const guardianShootInterval = 120; // Reverted to 80 (from 50% faster 50, then 50% faster 33)
...
const spaceshipBaseSpeed = 0.96; // Keep as is (from previous 60% increase)
...
// Invader Bullets (reverted to 1.2, 2.4, 0.64, 4.8, 1.2 from 2.4, 4.8, 1.28, 9.6, 2.4)
const invaderBullets = [];
const invaderBulletSpeed = 0.5; // Reverted to 1.2 (from 60% increase on 0.75, then 100% to 2.4)
const invaderBulletWidth = 5;
const invaderBulletHeight = 15;
const sniperBulletSpeed = 1.0; // Reverted to 2.4 (from 60% increase on 1.5, then 100% to 4.8)
const tankBulletWidth = 10;
const tankBulletSpeed = 0.25; // Reverted to 0.64 (from 60% increase on 0.4, then 100% to 1.28)
const bossLaserWidth = 8;
const bossLaserHeight = 30;
const bossLaserSpeed = 2.0; // Reverted to 4.8 (from 60% increase on 3.0, then 100% to 9.6)
const guardianBulletWidth = 15;
const guardianBulletHeight = 20;
const guardianBulletSpeed = 0.5; // Reverted to 1.2 (from 60% increase on 0.75, then 100% to 2.4)
let shootTimer = 0;
