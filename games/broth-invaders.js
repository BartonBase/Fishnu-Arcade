...
// Player Bullets (with pooling, keep at 8.8 as previously increased)
...
const bulletSpeed = 8.8; // Keep as is (from previous 60% increase)
...
// Invaders (keep at 1.2 as previously increased)
const invaders = [];
const invaderRows = 5;
...
// Stealth Invaders (Level 2, keep at 1.92 as previously increased)
...
// Invader Bullets (keep speeds at 1.2, 2.4, 0.64, 4.8, 1.2 as previously increased)
